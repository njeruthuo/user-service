...
func main() {
	...
	router.HandleFunc("/auth/forgot-password", authHandler.ForgotPasswordHandler).Methods(http.MethodPost)
	router.HandleFunc("/auth/reset-password", authHandler.ResetPasswordHandler).Methods(http.MethodPost)
	router.HandleFunc("/auth/change-password", authHandler.ChangePasswordHandler).Methods(http.MethodPost)
